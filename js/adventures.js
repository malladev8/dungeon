const adventures = [
{
    ...
    tagline: "Dare to descend into the Underdark.",
...

{
    ...
    tagline: "A grand urban caper awaits you.",
...

{
    ...
    tagline: "A shadow falls over the land of Barovia.",
...

{
    ...
    tagline: "Feel the cold touch of death.",
...

{
    ...
    tagline: "Forge your fate in hellfire.",
...

{
    ...
    tagline: "Uncover scars of the Calamity.",
...

{
    ...
    synopsis: "A compilation of iconic dungeons and adventures from D&D's history, offering a variety of challenges and experiences.",
...

{
    ...
    tagline: "Secrets lie beneath the waves.",
    synopsis: "A collection of seafaring adventures tied toegether in the coastal town of Saltmarsh, where pirates, smugglers, and sea monsters await.",
    levels: "1–12",
